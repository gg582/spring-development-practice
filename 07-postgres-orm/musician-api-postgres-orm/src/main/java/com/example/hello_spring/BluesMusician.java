...
public class BluesMusician implements Musician {
	...
	// 하지 않습니다.
	public BluesMusician(IntroduceMusician introduceMusician) {
		System.out.println("Constructor for BluesMusician triggered");
		this.introduceMusician = introduceMusician;
	}

	// 생성, 초기화 후 실행
	public void init() {
		System.out.println("Initialize BluesMusician via init()");
	}

	// 소멸 전 실행
	public void destroy() {
		System.out.println("Destroy BluesMusician via destroy()");
	}
	...
	public String getIntroduce(String gender, String name) {
		return "Hello, Blues Musician, " + this.introduceMusician.introduce(gender, name);
	}
