...
public class MusicianService {
    ...
    public MusicianProfile register(String name, String gender, String genre) {
        ...
        if (existing != null) {
            throw new DuplicateMusicianException("Musician with name " + name + " already exists.");
        }
    ...
    public MusicianProfile findByName(String name) {
        ...
        if (profile == null) {
            throw new MusicianNotFoundException("Musician with name " + name + " not found.");
        }
        return profile;
    }
    ...
    public MusicianProfile findById(Long id) {
        ...
        if (profile == null) {
            throw new MusicianNotFoundException("Musician with id " + id + " not found.");
        }
        return profile;
    }
    ...
    public MusicianProfile findByGenre(String genre) {
        ...
        if (profile == null) {
            throw new MusicianNotFoundException("Musician with genre " + genre + " not found.");
        }
        return profile;
    }
