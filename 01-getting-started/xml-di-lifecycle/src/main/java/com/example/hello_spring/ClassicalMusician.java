...
public class ClassicalMusician implements Musician {
	...
	// 하지 않습니다.
	public ClassicalMusician(IntroduceMusician introduceMusician) {
		System.out.println("Constructor for ClassicalMusician triggered");
		this.introduceMusician = introduceMusician;
	}

	// 생성, 초기화 후 실행
	public void init() {
		System.out.println("Initialize ClassicalMusician via init()");
	}

	// 소멸 전 실행
	public void destroy() {
		System.out.println("Destroy ClassicalMusician via destroy()");
	}
	...
	public String getIntroduce(String gender, String name) {
		return "Hello, Classical Musician, " + this.introduceMusician.introduce(gender, name);
	}
