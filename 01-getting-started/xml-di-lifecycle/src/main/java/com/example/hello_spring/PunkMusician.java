...
public class PunkMusician implements Musician {
	...
	// 하지 않습니다.
	public PunkMusician(IntroduceMusician introduceMusician) {
		System.out.println("Constructor for PunkMusician triggered");
		this.introduceMusician = introduceMusician;
	}

	// 생성, 초기화 후 실행
	public void init() {
		System.out.println("Initialize PunkMusician via init()");
	}

	// 소멸 전 실행
	public void destroy() {
		System.out.println("Destroy PunkMusician via destroy()");
	}
	...
	public String getIntroduce(String gender, String name) {
		return "Hello, Punk Musician, " + this.introduceMusician.introduce(gender, name);
	}
